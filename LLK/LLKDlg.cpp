...
BEGIN_MESSAGE_MAP(CLLKDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDCANCEL, &CLLKDlg::OnBnClickedCancel)
	ON_BN_CLICKED(IDC_BUTTON1, &CLLKDlg::OnClickedBTNBasic)
END_MESSAGE_MAP()
...
void CLLKDlg::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	CDialogEx::OnCancel();
}
...
{
	// TODO: 在此添加控件通知处理程序代码
	this->ShowWindow(SW_HIDE); //自动关闭主窗口
	CGameDlg dig;
	dig.DoModal();
